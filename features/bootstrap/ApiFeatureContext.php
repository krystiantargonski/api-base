...
class ApiFeatureContext implements Context {
    ...
    public function iRequest($httpMethod, $resource) {
        ...
        foreach ($this->payloadData as $key => $value) {
            $this->requestPayload = str_replace('<<' . $key . '>>', $value, $this->requestPayload);
        }
    ...
    public function thePropertyContainsItems($property, $count) {
        ...
        assertCount(
                (int) $count, $this->arrayGet($payload, $property), "Asserting the [$property] property contains [$count] items: " . json_encode($payload)
        );
    }
    ...
    private function getOutput() {
        ...
        return $this->output; // TODO: Implement setKernel() method.
    }
    ...
    /**
     * @Given I save :arg1 property into :arg2 key
     */
    public function iSavePropertyIntoKey($arg1, $arg2) {
        $payload = $this->getScopePayload();
        $actualValue = $this->arrayGet($payload, $arg1);
        $this->data[$arg2] = $actualValue;
    }
    
    /**
     * @Given I save payload :arg1 property into :arg2 key
     */
    public function iSaveOayloadPropertyIntoKey($arg1, $arg2) {
        $payload = $this->getScopePayload();
        $actualValue = $this->arrayGet($payload, $arg1);
        $this->payloadData[$arg2] = $actualValue;
    }
